...
app.post('/api/project/create/:id', async (req, res) => {
  try {
    ...
    const projectAndUserIds = await knex('user_projects').insert({ //TODO is projectAndUserIds actually called anywhere? It's returning an "unused variable" linter error
      user_id: userId,
